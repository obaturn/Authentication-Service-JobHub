...
/**
 * Event published when a user updates an experience
 */
@Data
@Builder
@NoArgsConstructor
...
public class ExperienceUpdatedEvent {
    ...
    private UUID userId;
    private String eventType;        // EXPERIENCE_UPDATED
    ...
    public static ExperienceUpdatedEvent fromExperience(Experience experience, UUID userId, String correlationId) {
        return ExperienceUpdatedEvent.builder()
