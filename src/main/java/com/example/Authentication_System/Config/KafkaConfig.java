...
/**
 * Kafka configuration for producing events
 */
@Configuration
public class KafkaConfig {
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        // Add type info to headers for deserialization
    ...
    // Keep the specific UserRegisteredEvent factory for backward compatibility
    @Bean
